...
\BiChapter{非规则的为基站部署的性能分析}{Performace Analysis}
...
通过对密集热点区域无线网络的系统建模，即可对密集热点区域无线网络的下行链路进行分析。通过性能分析，我们可以得到用户的信干比，网络的覆盖率，网络的单位面积频谱利用率等性能指标。

\BiSection{非规则基站部署的系统建模}{System Model}
...
\BiSection{非规则网络的性能分析}{performance analysis}
