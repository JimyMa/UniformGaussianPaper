...
\newcommand{\englishthesistitle}{\uppercase{performance analysis and optimization in dense hotspot wireless networks}} %\uppercase作用：将英文标题字母全部大写；
...
优化的过程分为两步，
第一步出于对网络的同步性和复杂度要求的考虑本文提出了基于深度优先搜索和以用户为中心的微基站分簇(~Base Station Clustering~)算法，
